...
class DummyData: ObservableObject {
    @Published var posts: [Post] = [
        ...
        Post(id: "1", title: "Content About Programming", url: "https://www.youtube.com/watch?v=kmD25Coj5Mw", site: "test", slug: "test", content: "test", userID: "1",owner:
            ...
            comments: [
            Comment(id: "1", content: "test", userID: "1", owner: "test", postID: "1", post: "test", parentID: "1", parent: nil, comments: [], upvotes: [], createdAt: Date(), updatedAt: Date(), deletedAt: Date(), notifications: [])
            ],
